...
mod "cyberduck",          "1.0.1",   :github_tarball => "boxen/puppet-cyberduck"
mod "chrome",             "1.2.0",   :github_tarball => "boxen/puppet-chrome"
mod "firefox",            "1.2.3",   :github_tarball => "boxen/puppet-firefox"
mod "sourcetree",         "1.0.0",   :github_tarball => "boxen/puppet-sourcetree"
mod "sublime_text",       "1.1.1",   :github_tarball => "boxen/puppet-sublime_text"
